...
bulbasaur = Pokemon.create(name: "Bulbasaur", kind: "Grass/Poison", level: 15, dex_num: 1, move_one: "Razorleaf", move_two: "Vine Whip", move_three: "Poison Powder", move_four: "Sleep Powder", img_url: "https://img.pokemondb.net/sprites/black-white/anim/normal/bulbasaur.gif")
