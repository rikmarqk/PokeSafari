...
charmader = Pokemon.create(name: "Charmander", kind: "Fire", level: 15, dex_num: 4, move_one: "Ember", move_two: "Fire Spin", move_three: "Sunny Day", move_four: "Tackle", img_url: "https://img.pokemondb.net/sprites/black-white/anim/normal/charmander.gif")
